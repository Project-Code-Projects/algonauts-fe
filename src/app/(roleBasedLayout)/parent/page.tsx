...
const styles = {
  ...
  childrenListTitle: "text-center text-2xl font-bold mb-4",
  studentCardContainer: "flex flex-col items-center justify-center gap-4",
  studentCard:
    "w-2/3  bg-blue-100 p-4 rounded-lg shadow-md transition-transform duration-300 hover:scale-105 flex items-center ",
